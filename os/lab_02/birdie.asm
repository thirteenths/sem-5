...
data segment 'data'
    ; gdt - метка начала GDT
    gdt_label	label byte
    ...
    gdt_code_32 descr <code_32_size - 1, 0, 0, 98h, 40h, 0>	    ; Селектор 24
    ;--------------------------------------------------------------------------
	gdt_data_32	descr <0FFFFh, 0, 0, 92h, 0CFh, 0>			    ; Селектор 32
	gdt_stack32 descr <stack_size-1,0,0,92h,40h,0>              ; Селектор 40
    gdt_screen	descr <4095, 8000h, 0Bh, 92h>                   ; Селектор 48
	...
	idt_label	label byte
	descr_inter 13 	dup (<0, 40, 0, 8Fh, 0>)    ; Исключение общей защиты.
	...
	idt_timer_32 		descr_inter <int_32_off, 40, 0, 8Eh, 0> ; Таймер
	idt_keybord_33		descr_inter <int_33_off, 40, 0, 8Eh, 0> ; Клавиатура
